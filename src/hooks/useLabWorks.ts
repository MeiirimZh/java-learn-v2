// Загружает список лабораторных работ из локальной SQLite-базы данных и отслеживает загрузку данных
// Возвращает лабораторные работы и средства для управления их состоянием
